...
const Quantitiy = ({ maxq ,Quantitiy}) => {
    ...
    return (
        <View style={{ flexDirection: 'row', borderRadius: 5, borderWidth: 1, borderColor: '#d89216', width: width / 3, marginLeft: 15,height:width/15, marginTop: 15 }}>
            ...
            <TextInput style={{ width: width / 6, color: '#d89216', fontSize: width / 26, height: width / 15, padding: 0, paddingStart: 10, paddingRight: 10, textAlign: 'center' }} defaultValue={"" + q} keyboardType={'decimal-pad'} maxLength={maxq.toString().length} onChangeText={(text) => changeText(text)} onEndEditing={() => endEditing()} />
